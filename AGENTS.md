...
| [.claude/skills/gap-closure-contract/](.claude/skills/gap-closure-contract/) | Claude Code skill for mandatory gap closure contracts |
| [.claude/skills/task-registry-flow/](.claude/skills/task-registry-flow/) | Claude Code skill for plugin-owned plan activation |
| [GEMINI.md](GEMINI.md) | Antigravity (`agy`) entry — same governance, Antigravity-native paths |

**Active agents:** Codex (this file + [.codex/config.toml](.codex/config.toml) + [.codex/hooks.json](.codex/hooks.json) + [.agents/skills/](.agents/skills/)), Antigravity CLI 1.0.3+ ([GEMINI.md](GEMINI.md) + [.agents/skills/](.agents/skills/) + [.agents/hooks.json](.agents/hooks.json)), Cursor ([.cursor/rules/agent-governance.mdc](.cursor/rules/agent-governance.mdc) + [.cursor/skills/](.cursor/skills/) + [.cursor/hooks.json](.cursor/hooks.json)), and Claude Code ([.claude/settings.json](.claude/settings.json) + [.claude/skills/](.claude/skills/)).
...
| Claude Code hooks | `.claude/settings.json` → canonical gate (`PreToolUse`) |
| Skills | `.agents/skills/*`, `.agents/skills/*.md`, `.cursor/skills/*`, `.claude/skills/*` |
